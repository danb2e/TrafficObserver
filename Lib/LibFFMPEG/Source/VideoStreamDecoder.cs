...
{ 
    public sealed unsafe class VideoStreamDecoder : IDisposable
    {
        ...
        int test = ffmpeg.avformat_find_stream_info(_pFormatContext, null);
        ...
        ffmpeg.avcodec_open2(_pCodecContext, codec, null);
            ...
            //ulong a = 0;
            //byte* test_sidedata = ffmpeg.av_stream_get_side_data(_pFormatContext->streams[_streamIndex], AVPacketSideDataType.AV_PKT_DATA_DISPLAYMATRIX, &a);
        }
